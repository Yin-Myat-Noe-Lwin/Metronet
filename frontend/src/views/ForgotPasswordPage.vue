    ...
    <div class="container">
      <div class="forgot-container">
        ...
        <form @submit.prevent="handleSubmit" novalidate>
          ...
          <!-- Submit Button -->
          <button type="submit" class="forgot-btn" :disabled="!isFormValid || isLoading">
...
export default {
  ...
  computed: {
    ...
    isFormValid() { return !this.emailError && this.form.email },
  },
  methods: {
    ...
    async handleSubmit() {
      ...
      try {
        ...
        this.globalError = error.response?.data?.message || 'Failed to send reset link. Please try again.'
      } finally {
...
@media (max-width: 480px) {
  .forgot-container { padding: 28px 20px; border-radius: 16px; }
